  ...
  Future<void> _loadRoles() async {
    ...
    setState(() {
      ...
      if (res["success"] == true && res["data"] != null) {
        ...
        if (roleLower == "ceo") {
          // Show only hr,accountant,superadmin
          ...
          // Show only superadmin,admin,employee
          _roles = _roles.where((r) {
            final roleName = (r["RoleName"] ?? "").toString().toLowerCase();
            return roleName == "superadmin" || roleName == "admin" || roleName == "employee";
          }).toList();
        } else if (roleLower == "superadmin") {
          // Show only admin,employee
          _roles = _roles.where((r) {
            final roleName = (r["RoleName"] ?? "").toString().toLowerCase();
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "You can add: ${_currentUserRole == "ceo"
                    ...
                    children: [
                      ...
                      CustomDropdownField<int>(
                        ...
                        onChanged: (value) async {
                          ...
                          if ((_currentUserRole ?? '').toLowerCase() == 'ceo' &&
